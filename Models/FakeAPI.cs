...
namespace LaborNeedsScheduling.Models
{
    public class FakeAPI
    {
        ...
        public static void dothething(/*DateTime[] weekdates*/)
        {
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    DataTable StoreList = new DataTable();
                    ...
                    cmd.CommandText = "select LocationCode from DW.dbo.Location where LocationCode <> '1031' and LocationCode <> '1008'";

                    da.Fill(StoreList);

                    for (int i = 0; i < StoreList.Rows.Count; i++)
                    {
                        cmd.CommandText = "insert into LaborScheduling.dbo.StoreVariables values ('" + StoreList.Rows[i][0] +
                            "', '3','4','15','3','4','36','24','16','12','8','4','09:00:00','18:30:00','09:00:00','20:30:00'," +
                            "'09:00:00','20:30:00','09:00:00','20:30:00','09:00:00','20:30:00','09:00:00','21:00:00','09:00:00'," +
                            "'21:00:00')";
                        cmd.ExecuteNonQuery();
                    }
                    ...
                    //    {
                    //        cmd.CommandText = "insert into LaborScheduling.dbo.EmployeeAvailability(EmployeeId, Hour, Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday)"
        ...
        public static string GetStoreCode(string User)
        {
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "select StoreCode from Intranet.dbo.UserAttributes where UserId='" + User + "'";
                    da.Fill(dt);
        ...
        public static string GetDistrictCode(string User)
        {
            string DistrictCode = "";
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "select DistrictCode from Intranet.dbo.UserAttributes where UserId='" + User + "'";
                    da.Fill(dt);

                    DistrictCode = dt.Rows[0][0].ToString();
        ...
        public static List<string> GetStoresForDistrict(string DistrictCode)
        {
            List<string> StoreCodes = new List<string>();
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "select StoreCode from Intranet.dbo.StoreLocations where DistrictCode = '" + DistrictCode + "'";
                    da.Fill(dt);

                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        StoreCodes.Add(dt.Rows[i][0].ToString());
                    }
        ...
        public static int GetMinEmployeesEarly(string LocationCode)
        {
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "select MinEmployeesEarly from LaborScheduling.dbo.StoreVariables where LocationCode = '" + LocationCode + "'";
        ...
        public static int GetMinEmployeesLater(string LocationCode)
        {
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "select MinEmployeesLater from LaborScheduling.dbo.StoreVariables where LocationCode = '" + LocationCode + "'";
        ...
        public static void UpdateMinEmployeesEarly(int MinEmployees, string LocationCode)
        {
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "update LaborScheduling.dbo.StoreVariables set MinEmployeesEarly = '" + MinEmployees + "' where LocationCode = '" + LocationCode + "'";
        ...
        public static void UpdateMinEmployeesLater(int MinEmployees, string LocationCode)
        {
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "update LaborScheduling.dbo.StoreVariables set MinEmployeesLater = '" + MinEmployees + "' where LocationCode = '" + LocationCode + "'";
        ...
        public static int GetMaxEmployees(string LocationCode)
        {
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "select MaxEmployees from LaborScheduling.dbo.StoreVariables where LocationCode = '" + LocationCode + "'";
        ...
        public static void UpdateMaxEmployees(int MaxEmployees, string LocationCode)
        {
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "update LaborScheduling.dbo.StoreVariables set MaxEmployees = '" + MaxEmployees + "' where LocationCode = '" + LocationCode + "'";
        ...
        public static int GetWeekdayPowerHours(string LocationCode)
        {
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "select WeekdayPowerHours from LaborScheduling.dbo.StoreVariables where LocationCode = '" + LocationCode + "'";
        ...
        public static void UpdateWeekdayPowerHours(int WeekdayPowerHours, string LocationCode)
        {
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "update LaborScheduling.dbo.StoreVariables set WeekdayPowerHours = '" + WeekdayPowerHours + "' where LocationCode = '" + LocationCode + "'";
        ...
        public static int GetWeekendPowerHours(string LocationCode)
        {
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "select WeekendPowerHours from LaborScheduling.dbo.StoreVariables where LocationCode = '" + LocationCode + "'";
        ...
        public static void UpdateWeekendPowerHours(int WeekendPowerHours, string LocationCode)
        {
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "update LaborScheduling.dbo.StoreVariables set WeekendPowerHours = '" + WeekendPowerHours + "' where LocationCode = '" + LocationCode + "'";
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "select SundayOpen, MondayOpen, TuesdayOpen, WednesdayOpen, ThursdayOpen, FridayOpen, SaturdayOpen " +
                                      "from LaborScheduling.dbo.StoreVariables where LocationCode = '" + LocationCode + "'";
                    SqlDataAdapter da = new SqlDataAdapter(cmd);
                    da.Fill(OpenTimes);
        ...
        public static void UpdateStoreHours(string LocationCode, string[] OpenHours, string[] CloseHours)
        {
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "update LaborScheduling.dbo.StoreVariables set SundayOpen = '" + OpenHours[0] + "', MondayOpen = '" + OpenHours[1] +
                    ...
                    cmd.CommandText = "update LaborScheduling.dbo.StoreVariables set SundayClose = '" + CloseHours[0] + "', MondayClose = '" + CloseHours[1] +
                ...
                try
                {
                    ...
                    if (endDateString != "")
                    {
                        ...
                        for (int i = 0; i < dates.Count; i++)
                        {
                            ...
                            cmd.CommandText = "select * from LaborScheduling.dbo.EmployeeSchedule where ScheduleDate = '" + dates[i] + "' " +
                    ...
                    cmd.CommandText = "delete from LaborScheduling.dbo.Messages where ID = '" + messageId + "' and LocationCode = '" + LocationCode + "'";
                    cmd.ExecuteNonQuery();
        ...
        //            cmd.CommandText = "delete from LaborScheduling.dbo.EmployeeSchedule where ScheduleDate = '" + CurrentWeekDates[selectedDay] + "' and EmployeeId = '" + employeeId + "'";
        //            cmd.ExecuteNonQuery();
        ...
        //            //cmd.CommandText = "update LaborScheduling.dbo.EmployeeSchedule set BeginTime = '" + startHours + "', EndTime = '" + endHours + "', "
        ...
        //            {
        //                cmd.CommandText = "update LaborScheduling.dbo.EmployeeSchedule set OnSchedule = 0 where EmployeeId = '"
        ...
        public static void UpdateExcludedDates(string LocationCode, DateTime[] DatesToExclude)
        {
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "delete from LaborScheduling.dbo.ExcludedDates where LocationCode = '" + LocationCode + "'";
                    cmd.ExecuteNonQuery();

                    for (int i = 0; i < DatesToExclude.Length; i++)
                    {
                        cmd.CommandText = "insert into LaborScheduling.dbo.ExcludedDates (LocationCode, Date) " +
        ...
        public static List<DateTime> GetExcludedDates(string LocationCode)
        {
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "select * from LaborScheduling.dbo.ExcludedDates where LocationCode = '" + LocationCode + "'";
                    SqlDataAdapter da = new SqlDataAdapter(cmd);
                    da.Fill(excluded);
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    for (int i = 0; i < RequestedDates.Length; i++)
                    {
                        ...
                        {
                            cmd.CommandText = "select * from LaborScheduling.dbo.EmployeeSchedule where EmployeeId = '" + EmployeeIds[n] + "' and ScheduleDate = '" + PreviousWeekDates[i] + "'";
                            da.Fill(LastWeekSchedule);
                            cmd.CommandText = "delete from LaborScheduling.dbo.EmployeeSchedule where EmployeeId = '" + EmployeeIds[n] + "' and ScheduleDate = '" + RequestedDates[i] + "'";
                            cmd.ExecuteNonQuery();
                        }
                    }
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    for (int i = 0; i < RequestedDates.Length; i++)
                    {
                        for (int n = 0; n < EmployeeIds.Length; n++)
                        {
                            cmd.CommandText = "delete from LaborScheduling.dbo.EmployeeSchedule where EmployeeId = '" + EmployeeIds[n] + "' and  LocationCode = '" + LocationCode + "' " +
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    for (int i = 0; i < employeeIds.Length; i++)
                    {
                        ...
                        cmd.CommandText = "select * from LaborScheduling.dbo.EmployeeAvailability where EmployeeId = '" + employeeIds[i] + "'";
                ...
                try
                {
                    ...
                    for (int i = 0; i < employeeIds.Length; i++)
                    {
                        ...
                        for (int n = 0; n < days.Length; n++)
                        {
                            ...
                            //cmd.CommandText = "select Hour from LaborScheduling.dbo.emp_" + employeeIds[i]
                            //                  + " where " + weekdays[n] + " = 'True'";

                            cmd.CommandText = "select BeginTime, EndTime from LaborScheduling.dbo.EmployeeSchedule"
        ...
        public static Dictionary<string, Dictionary<DateTime, string[]>> GetEmployeeTimeOff(string LocationCode, DateTime[] currentWeekDates)
        {
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "select EmployeeCode, StartDate, EndDate, StartTime, EndTime from LaborScheduling.dbo.Messages "
                                    + "where LocationCode = '" + LocationCode + "'"
                                    + " and Approved = '1'";
        ...
        public static DataTable GetFutureTimeOff(string LocationCode)
        {
            DataTable TimeOffTable = new DataTable();
        ...
        public static List<EmployeeNotification> GetMessagesForEmployee(string employeeId)
        {
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "select * from LaborScheduling.dbo.Messages" +
        ...
        public static List<ManagerNotification> GetMessagesForManager(string LocationCode)
        {
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    //cmd.CommandText = "select Id, Message, Created from LaborScheduling.dbo.TimeOffRequests";
                    cmd.CommandText = "select ID, Created, EmployeeCode, Name, StartDate, EndDate, StartTime, EndTime from LaborScheduling.dbo.Messages"
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    for (int i = 0; i < 7; i++)
                    {
                        ...
                        cmd.CommandText = "select BeginTime, EndTime from LaborScheduling.dbo.EmployeeSchedule where EmployeeId = '" + EmployeeID + "' "
                ...
                try
                {
                    ...
                    for (int i = 0; i < ScheduleHalfHourSlots.Length; i++)
                    {
                        cmd.CommandText = "select Hour, Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday"
                                        + " from LaborScheduling.dbo.EmployeeAvailability where EmployeeId = '" + EmployeeId + "'"
        ...
        public static DataTable FindEmployee(string EmployeeId)
        {
            ...
            double n;
            bool isNum = double.TryParse(EmployeeId, out n);
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    if (isNum)
                    {
                        //check if input is a store code or employee ID number
                        if (EmployeeId.Length == 4)
                        {
                            cmd.CommandText = "select * from LaborScheduling.dbo.Employees where PrimaryLocationCode = '" + EmployeeId + "'";
                        }
                        else if (EmployeeId.Length == 6)
                        {
                            cmd.CommandText = "select * from LaborScheduling.dbo.Employees where EmployeeCode = '" + EmployeeId + "'";
                        }
                    }
                    else
                    {
                        string[] name = EmployeeId.Split(' ');
                        string firstname = name[0];
                        string lastname = name[1];

                        cmd.CommandText = "select * from LaborScheduling.dbo.Employees where FirstName = '" + firstname + "' " +
        ...
        public static void AddBorrowedEmployee(string EmployeeId, string BorrowedLocationCode, DateTime[] NextFourWeeksDates)
        {
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "select * from LaborScheduling.dbo.BorrowedEmployees where EmployeeCode = '" + EmployeeId + "' " +
                    ...
                    if (EmployeeCheck.Rows.Count != 0)
                    {
                        ...
                        {
                            cmd.CommandText = "update LaborScheduling.dbo.BorrowedEmployees set Active = '1' where EmployeeCode = '" + EmployeeId + "' " +
                                          "and BorrowedLocationCode = '" + BorrowedLocationCode + "'";
                            cmd.ExecuteNonQuery();
                        }
                    }
                    ...
                    {
                        cmd.CommandText = "insert into LaborScheduling.dbo.BorrowedEmployees (EmployeeCode, LocationCode, BorrowedLocationCode, Active) " +
                    ...
                    {
                        cmd.CommandText = "select EmployeeId from LaborScheduling.dbo.EmployeeSchedule where EmployeeId = '" + EmployeeId + "' " +
        ...
        public static void RemoveBorrowedEmployee(string EmployeeId, string BorrowedLocationCode)
        {
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    cmd.CommandText = "update LaborScheduling.dbo.BorrowedEmployees set Active = '0' where EmployeeCode = '" + EmployeeId + "' " +
                                      "and BorrowedLocationCode = '" + BorrowedLocationCode + "'";
                    cmd.ExecuteNonQuery();
            ...
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    for (int i = 0; i < TrafficDates.Count; i++)
                    {
                        ...
                        cmd.CommandText = "select TrafficDate, TrafficTime, TrafficCount from DW.dbo.StoreTraffic where Convert(VARCHAR(10), TrafficDate, 120) = "
                ...
                try
                {
                    ...
                    for (int i = 0; i < employees.Count; i++)
                    {
                        for (int n = 0; n < CurrentWeekDates.Length; n++)
                        {
                            ...
                            cmd.CommandText = "select EmployeeId from LaborScheduling.dbo.EmployeeSchedule where EmployeeId = '" + employees[i].id + "' " +
        ...
        public static void SubmitTimeOffRequest(string created, string startDate, string endDate, string Name, string Id, string LocationCode, string startTime, string endTime, string message)
        {
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    //cmd.CommandText = "insert into LaborScheduling.dbo.TimeOffRequests (Created, DateStart, DateEnd, Name, Id, StartTime, EndTime, Message)" +
                    //                  "values ('" + created + "', '" + startDate + "', '" + endDate + "', '" + Name + "', '" + Id + "', '" + startTime +
                    //                  "', '" + endTime + "', '" + message + "');";

                    cmd.CommandText = "insert into LaborScheduling.dbo.Messages (Created, Type, EmployeeCode, LocationCode, Name, StartDate, EndDate, StartTime, EndTime)" +
        ...
        /// <param name="employeeId"></param>
        public static void UpdateEmployeeAvailability(AvailabilityViewModel avm, List<string> schedule, string employeeId, DateTime[] NextFourWeeksDates, string StoreCode)
        {
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                try
                {
                    ...
                    foreach (string value in schedule)
                    {
                        ...
                        cmd.CommandText = "update LaborScheduling.dbo.EmployeeAvailability set " + days[counter] + " = '" + bit +
                    ...
                    for (int x = 0; x < 4; x++)
                    {
                        DateTime[] currentweek = new DateTime[7];
                        for (int i = 0; i < 7; i++)
                        {
                            currentweek[i] = NextFourWeeksDates[x * 7 + i];
                        }

                        DataTable assigned = GetEmployeeSchedule(employeeId, currentweek);
                        DataTable available = GetEmployeeAvailability(employeeId);
                        string[] employeeIds = new string[1];
                        employeeIds[0] = employeeId;
                        Dictionary<string, Dictionary<string, string[]>> EmployeeScheduledTimes = FakeAPI.GetEmployeeScheduledTimes(employeeIds, StoreCode, currentweek);
                        Dictionary<string, string[]> EmployeeAssignedTimes = EmployeeScheduledTimes[employeeId];
                        for (int i = 1; i < assigned.Columns.Count; i++)
                        {
                            List<string> UnassignTimes = new List<string>();

                            for (int n = 0; n < assigned.Rows.Count; n++)
                            {
                                if (assigned.Rows[n][i].ToString() == "True" && available.Rows[n][i].ToString() == "False")
                                {
                                    UnassignTimes.Add(assigned.Rows[n][0].ToString());
                                }
                            }
                            string unassigntimes = "";
                            for (int n = 0; n < UnassignTimes.Count; n++)
                            {
                                if (n == UnassignTimes.Count - 1)
                                {
                                    unassigntimes += UnassignTimes[n];
                                }
                                else
                                {
                                    unassigntimes += UnassignTimes[n] + ",";
                            ...
                            FakeAPI.UnassignEmployee(unassigntimes, employeeId, i - 1, EmployeeScheduledTimes, currentweek, StoreCode);
                        }
                    }
                }
                catch (Exception ex)
                            ...
                            Dictionary<string, string[]> EmployeeScheduledTimes, int weekday, string LocationCode)
        {
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                ...
                cmd.CommandText = "delete from LaborScheduling.dbo.EmployeeSchedule where ScheduleDate = '" + date + "' and EmployeeId = '" + employeeId + "'";
                cmd.ExecuteNonQuery();
                ...
                for (int i = 0; i < assignedHourBlocks.Count; i++)
                {
                    ...
                    //cmd.CommandText = "update LaborScheduling.dbo.EmployeeSchedule set BeginTime = '" + BeginTime + "', EndTime = '" + EndTime + "', "
        ...
        public static void AddNewWeekDates(DateTime[] CurrentWeekDates)
        {
            using (SqlConnection conn = new SqlConnection(strSQLCon))
            {
                ...
                dateCheck.CommandText = "select ScheduleDate from LaborScheduling.dbo.EmployeeSchedule where ScheduleDate = '" + CurrentWeekDates[0] + "'";
